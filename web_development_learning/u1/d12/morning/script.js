...
$(document).ready(function() {
  ...
  //    var $submitFunc = $('#inputSubmit')
  //    $submitFunc.on("click", function(){
  //     var $inputValue = $('input').val();
  //     console.log($inputValue);
  //     var chosenPhil = [];
  //     for (var i=0; i<philosophers.length; i++){
  //       for(var key in philosophers[i]){
  //         if (philosophers[i][key].find($inputValue)){
  //           chosenPhil.push(philosophers[i]);
  //               console.log("Chosen"+chosenPhil);
  //         }
  //       }
  //     }
  //    })
